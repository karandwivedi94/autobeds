...
import { Deferred, getItemAsync, getParameterByName, isBrowser, removeItemAsync, resolveFetch, setItemAsync, uuid, } from './lib/helpers';
...
export default class GoTrueClient {
            ...
            try {
                ...
                if ('email' in credentials) {
                    ...
                    const { error } = yield _request(this.fetch, 'POST', `${this.url}/otp`, {
                        ...
                        body: {
                            email,
                            create_user: (_a = options === null || options === void 0 ? void 0 : options.shouldCreateUser) !== null && _a !== void 0 ? _a : true,
                            gotrue_meta_security: { captcha_token: options === null || options === void 0 ? void 0 : options.captchaToken },
                        },
                        redirectTo: options === null || options === void 0 ? void 0 : options.emailRedirectTo,
                    });
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                if (!jwt) {
                    ...
                    jwt = (_b = (_a = data.session) === null || _a === void 0 ? void 0 : _a.access_token) !== null && _b !== void 0 ? _b : this.headers['Authorization'];
                }
    ...
    _startAutoRefreshToken(value, session) {
        ...
        this.refreshTokenTimer = setTimeout(() => __awaiter(this, void 0, void 0, function* () {
            ...
            if (error instanceof AuthRetryableFetchError &&
                this.networkRetries < NETWORK_FAILURE.MAX_RETRIES)
                this._startAutoRefreshToken(Math.pow(NETWORK_FAILURE.RETRY_INTERVAL, this.networkRetries) * 100, session); // exponential backoff
        }), value);

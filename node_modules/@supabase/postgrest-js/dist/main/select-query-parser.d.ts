 ...
 */
declare type ConstructFieldDefinition<Table extends Record<string, unknown>, Field> = Field extends {
    star: true;
} ? Table : Field extends {
    name: string;
    foreignTable: true;
...
declare type GetResultHelper<Table extends Record<string, unknown>, Fields extends unknown[], Acc> = Fields extends [infer R] ? GetResultHelper<Table, [], ConstructFieldDefinition<Table, R> & Acc> : Fields extends [infer R, ...infer Rest] ? GetResultHelper<Table, Rest, ConstructFieldDefinition<Table, R> & Acc> : Acc;
/**
 ...
 */
export declare type GetResult<Table extends Record<string, unknown>, Query extends string> = ParseQuery<Query> extends unknown[] ? GetResultHelper<Table, ParseQuery<Query>, unknown> : ParseQuery<Query>;
export {};
